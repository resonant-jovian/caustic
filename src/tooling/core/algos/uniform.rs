...
impl PhaseSpaceRepr for UniformGrid6D {
    fn compute_density(&self) -> DensityField {
        ...
        let data: Vec<f64> = (0..nx1 * nx2 * nx3)
            .map(|si| {
                let ix3 = si % nx3;
                let ix2 = (si / nx3) % nx2;
                let ix1 = si / (nx2 * nx3);
                    ...
                    for iv2 in 0..nv2 {
                        for iv3 in 0..nv3 {
                            let line: Vec<f64> = (0..nv1)
                                ...
                                .collect();
                            let shifted =
                                sl_shift_1d(&line, disp[0], dv[0], nv1, lv[0], periodic_v);
                            for iv1 in 0..nv1 {
                    ...
                    for iv1 in 0..nv1 {
                        for iv3 in 0..nv3 {
                            let line: Vec<f64> = (0..nv2)
                                ...
                                .collect();
                            let shifted =
                                sl_shift_1d(&line, disp[1], dv[1], nv2, lv[1], periodic_v);
                            for iv2 in 0..nv2 {
                    ...
                    for iv1 in 0..nv1 {
                        for iv2 in 0..nv2 {
                            let line: Vec<f64> = (0..nv3)
                                ...
                                .collect();
                            let shifted =
                                sl_shift_1d(&line, disp[2], dv[2], nv3, lv[2], periodic_v);
                            for iv3 in 0..nv3 {
